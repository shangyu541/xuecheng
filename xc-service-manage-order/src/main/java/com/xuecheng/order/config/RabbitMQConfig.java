...
public class RabbitMQConfig {
    ...
    public Queue xc_learning_addchoosecourse() {
     ...
     */
    @Bean
    public Binding binding_queue_ADDCOURSE(@Qualifier("xc_learning_addchoosecourse") Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
