...
public class Consumer_routing_sms {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
         ...
         * 声明交换机，声明交换机类型
         */
        channel.exchangeDeclare(EXCHANGE_FANNOT_INFO,BuiltinExchangeType.DIRECT,true,false,false,null);
        /**
         * 声明队列 queue
         */
...
//        channel.basicQos(1);
         ...
         * 消费消息
         */
        channel.basicConsume(QUEUE_INFO_SMS,false,defaultConsumer);
    }
}
